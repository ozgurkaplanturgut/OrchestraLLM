...
def main():
    ...
    parser.add_argument("--user", default="user_ozgur_1")
    parser.add_argument("--session", default="user_ozgur_1_session_1")
    ...
    # # 4) Travel
    # travel_qs = [
    #     "tokyoya gidicem aralıkta, orta bütçeliyim tatil planı yap",
    #     "bir de almanya için düşük bütçeli plan yap"
    # ]
